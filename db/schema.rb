...
ActiveRecord::Schema[7.1].define(version: 2023_12_04_014032) do
  ...
  create_table "bookmarks", force: :cascade do |t|
    ...
    t.index ["listings_id"], name: "index_bookmarks_on_listings_id"
  ...
  add_foreign_key "bookmarks", "listings", column: "listings_id"
